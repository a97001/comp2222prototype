								...
								<div class="dropdown share-dropdown">
									...
									<ul class="dropdown-menu" role="menu" aria-labelledby="postMenu_{posts.pid}">
										<li role="presentation">
											<!-- IF isFollowing -->
                                            <a href="#" role="menuitem" tabindex="-1" class="follow" title="[[topic:unwatch.title]]"><span>[[topic:unwatch]]</span> <i class="fa fa-eye-slash"></i>[[topic:unwatch]]</a>
											<!-- ELSE -->
                                            <a href="#" role="menuitem" tabindex="-1" class="follow" title="[[topic:watch.title]]"><span>[[topic:watch]]</span> <i class="fa fa-eye"></i>[[topic:watch]]</a>
											<!-- ENDIF isFollowing -->
										</li>
										<li role="presentation">
