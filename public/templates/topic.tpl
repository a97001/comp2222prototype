...
<!--								<li><a href="#" class="chat"><i class="fa fa-comment"></i> [[topic:chat]]</a></li>-->
						...
						<div class="btn-group">
							<button class="btn btn-sm btn-default follow hide" type="button" title="[[topic:notify_me]]"><!-- IF isFollowing --><i class="fa fa-eye-slash"> Watch<!-- ELSE --><i class="fa fa-eye"> Unwatch<!-- ENDIF isFollowing --></i></button>
							<!-- IF !posts.selfPost -->
<!--							<button class="btn btn-sm btn-default flag" type="button" title="[[topic:flag_title]]"><i class="fa fa-flag-o"></i></button>-->
						...
						<div class="btn-group">
							<button class="upvote btn btn-sm btn-default <!-- IF posts.upvoted --> upvoted btn-primary <!-- ENDIF posts.upvoted -->">
								<i class="fa fa-chevron-up"></i> Upvote
							</button>
							...
							<button class="downvote btn btn-sm btn-default <!-- IF posts.downvoted --> downvoted btn-primary <!-- ENDIF posts.downvoted -->">
								<i class="fa fa-chevron-down"></i> Downvote
							</button>
						...
						<div class="btn-group">
                            <button class="btn btn-sm btn-default quote" type="button" title="[[topic:quote]]"><i class="fa fa-quote-left"></i> [[topic:quote]]</button>
